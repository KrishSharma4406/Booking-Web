      ...
      <div className="relative z-10 max-w-sm sm:max-w-md w-full text-gray-400 space-y-6 sm:space-y-8">
        ...
        {loginMethod === 'phone' && (
          <form onSubmit={handlePhoneSubmit}>
            <div className="space-y-4 sm:space-y-5">
              <div>
                <label className="font-medium text-gray-300 text-sm sm:text-base"> Phone Number </label>
                <div className="flex gap-2 mt-2">
                  ...
                  {!otpSent ? (
                    <button
                      ...
                      disabled={isLoading}
                      className="px-4 py-2 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-500 rounded-lg transition-all disabled:opacity-50"
                    >
                      Send OTP
                    </button>
                  ) : (
                    <button
                      ...
                      className="px-4 py-2 text-sm font-medium text-white bg-gray-600 hover:bg-gray-500 rounded-lg transition-all"
                    >
                      Change
                    </button>
                  )}
              ...
              {otpSent && (
                <>
                  <div>
                    <label className="font-medium text-gray-300 text-sm sm:text-base"> OTP Code </label>
                    <input
                      type="text"
                      value={otp}
