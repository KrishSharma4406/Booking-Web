...
const ForgotPassword = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-purple-900 via-pink-900 to-black flex items-center justify-center">
      ...
      <div className="mt-7 bg-black/40 backdrop-blur-xl rounded-xl border border-pink-500/20 shadow-2xl">
        <div className="p-4 sm:p-7">
          <div className="text-center">
            <h1 className="block text-2xl font-bold bg-gradient-to-r from-pink-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">Forgot password?</h1>
      ...
      <p className="mt-3 flex justify-center items-center text-center divide-x divide-gray-600">
